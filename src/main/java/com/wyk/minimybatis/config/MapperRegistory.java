...
import com.wyk.minimybatis.Bootstrap;
import com.wyk.minimybatis.annotation.AnnotationUtil;
 ...
 * @Author: wyk
 * @Description:
 * @Date: Create in 2019/4/26 18:37
 * @Modified By:
 */
public class MapperRegistory {
    ...
    public MapperRegistory(String packageName) {
        ...
        // 获取
        realPackagePath = bootstrapPath + StringUtil.replaceAllChar(packageName, '.', '/');
